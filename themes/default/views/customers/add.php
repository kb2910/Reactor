<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                     <div class="form-group company nameRefence">
                        <?= lang("company", "company"); ?>
                        <?php echo form_input('company', '', 'class="form-control tip" id="company"'); ?>
                    </div>
                    <div class="form-group ">
                        <?= lang("dni","dni"); ?>
                        <?php echo form_input('dni', '', 'class="form-control" id="dni" data-bv-notempty="true"'); ?>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group person nameRefence">
                        <?= lang("name", "name"); ?>
