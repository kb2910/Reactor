...
<head>
    ...
    <title>SMA Pagina promocional</title>
    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="masthead clearfix">
                <div class="inner">
                    <h3 class="text-center">Apronta Stock</h3>
                </div>
            </div>

            <div class="inner cover">
                <h1 class="cover-heading">Apronta Stock</h1>
                <p class="lead">Apronta Stock is php based web application for small and medium business to manage inventory, sales (with online payments), expenses, customers and warehouses. </p>
                <p class="lead">
                    <a href="http://Apronta.com" class="btn btn-lg btn-primary">Buy Here</a>
                </p>
            </div>

            <div class="mastfoot">
                <div class="inner">
                    <p>Apronta Stock by <a href="http://Apronta.com">Apronta</a>.</p>
                </div>
            </div>
