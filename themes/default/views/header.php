                            ...
                            <ul class="dropdown-menu pull-right">
                                <li>
                                    <a href="<?= site_url('reports/quantity_alerts') ?>" class="">
                                        ...
                                        <span style="padding-right: 35px;"><?= lang('Alerta de cantidad') ?></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= site_url('reports/expiry_alerts') ?>" class="">
                                        ...
                                        <span style="padding-right: 35px;"><?= lang('Alerta de expiracion') ?></span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="col-sm-12 col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="right_log hidden-xs">
                                <?= " <span class='hidden-sm'>( " . lang('last_login_at') . ": " . date($dateFormats['php_ldate'], $this->session->userdata('old_last_login')) . " " . ($this->session->userdata('last_ip') != $ip_address ? lang('ip:') . ' ' . $this->session->userdata('last_ip') : '') . " )</span>" ?>
                            </li>
                        </ul>
                    </div>
                </div>
