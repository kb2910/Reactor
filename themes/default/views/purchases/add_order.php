                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="bottom-total" class="well well-sm" style="margin-bottom: 0;">
                            <table class="table table-bordered table-condensed totals" style="margin-bottom:0;">
                                <tr class="warning">
                                    <td><i class="fa fa-cubes" aria-hidden="true"></i> <?= lang('items') ?> <span class="totals_val pull-right" id="titems">0</span></td>
                                    <td><i class="fa fa-money" aria-hidden="true"></i> <?= lang('total') ?> <span class="totals_val pull-right" id="total">0.00</span></td>
                                </tr>
                            </table>
                        </div>
                    </div> 
