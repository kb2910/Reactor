 ...
 */
$config['site_title']                 = "Apronta Stock";       // Site Title, example.com This is not more functional
$config['admin_email']                = "Enzoburga@gmail.com"; // Admin Email, admin@example.com This is not more functional
